...
class gwenProfile extends StatefulWidget {
  const gwenProfile({super.key});

  @override
  State<gwenProfile> createState() => _gwenProfileState();
}

class _gwenProfileState extends State<gwenProfile> {
  @override
                ...
                children: [
                  ...
                  CircleAvatar(
                    ...
                    backgroundImage: NetworkImage(
                        'https://img.freepik.com/premium-photo/smiling-looking-friendly-showing-number-one-first-with-hand-forward-counting-down_1194-402703.jpg'),
